...
elseif inputFlag==1
    ...
    AirOrigCloudFile = 'neugasse_station1_xyz_intensity_rgb.mat';
    terrestrialOrigCloudFile= 'neugasse_station1_xyz_intensity_rgb.mat';
...
%
    ...
    maxDistance=1; %min distance between points that we want to add to region
    tic
...
%% display final result!!!
   cloudColor= colorPointCloud(Origcloud , realLables);
    figure;
    pcshow(cloudColor);
    xlabel('x');ylabel('y');zlabel('z');
    title('after all');
